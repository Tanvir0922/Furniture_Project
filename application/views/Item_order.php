...
<html>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>/Asset/css/Item.css">
...
<form method='post' action="Item_ordercon/Item_order">
            ...
            <div class="row">
              <div class="col-lg-6 px-5 py-4">
                ...
                <div class="d-flex align-items-center mb-5">
                  ...
                  <img src="http://localhost/project/Asset/images/sofa1.jpg" alt="Sofa" style="max-width: 85%;" >
